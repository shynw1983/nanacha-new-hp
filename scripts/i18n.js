...
const extraTexts = [
  ...
  "店舗一覧",
  "店舗一覧へ戻る",
  "nanacha の各店舗をご案内します。住所、営業時間、受け取り方法は店舗ごとにご確認ください。",
  "店舗情報を見る",
  "営業時間",
  "定休日",
  "最寄り",
  ...
  "トッピング",
  "Squareで注文・支払い",
  "nanacha のタピオカミルク、フラッペ、チーズティー、スムージー、ティー、コーヒーまで。 サイズ・甘さ・氷の量・トッピングを選んで、自分好みの一杯に。",
  "アレルギー・カフェインについて",
  "アレルギー",
